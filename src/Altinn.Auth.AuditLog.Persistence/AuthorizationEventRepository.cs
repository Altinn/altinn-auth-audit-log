    ...
    public class AuthorizationEventRepository : IAuthorizationEventRepository
    {
        ...
        public async Task InsertAuthorizationEvent(AuthorizationEvent authorizationEvent)
        {
            ...
            try
            {
                ...
                pgcom.Parameters.AddWithValue("created", NpgsqlTypes.NpgsqlDbType.TimestampTz, authorizationEvent.Created == DateTime.MinValue ? DBNull.Value : authorizationEvent.Created);
